  ...
  const packages = [
    {
      ...
      yearprice: 199,
      description:
        "A common from of lorem ipsum reads:Lorem ipsum dolor sit amet,consectetur adipiscing elit.",
  ...
  return (
    <div className="md:px-14 p-4 max-w-s mx-auto py-10" id="pricing">
      <div className="text-center">
        ...
        <p className="text-tartoary md:w-1/3 mx-auto px-4">
        ...
        <div className="mt-16">
          ...
          >
            ...
            <div className="w-14 h-6 bg-gray-300 rounded-full transition rounded-200  ease-in-out">
              <div
        ...
        {packages.map((pkg, index) => (
          ...
          >
            ...
            <p className="mt-5 text-center text-secondary text-4xl font-bold">
              {isYearly ? `$${pkg.yearprice}` : `$${pkg.monthprice}`}
              <span className="text-base text-artiary font-medium">
                {isYearly ? "year" : "month"}
              </span>
            </p>
            <ul className="mt-4 space-y-2 px-4">
              <li className=" flex gap-3 items-center">
                <img src={pkg.green} alt="" className="w-5 h-4" />
                Videos of Lessons
              </li>
