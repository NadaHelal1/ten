...
const Navbar = () => {
  ...
  return (
    <>
      <nav className="bg-white md:px-14 border-b p-4 max-w-screen-2x1 mx-auto text-primary fixed top-0 right-0 left-0 ">
          ...
          <div className="flex space-x-14 items-center">
            ...
            >
              <img
                src={logo}
                alt=""
                className="w-10 inlinw-block items-center"
              />
              <span>XYZ</span>
            </a>
            {/* maping for the array */}
      ...
      <div
        className={`text-lg space-y-4 px-4 pt-24 pb-5 bg-secondary ${
